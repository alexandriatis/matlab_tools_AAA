function Zp = planefit_AAA(Z)
% function Zp = planefit_AAA fits a plane to a matrix of scattered points.
%
% Inputs: Z, a matrix of scattered points, can include NaNs
% Outputs: Zp, a matrix representing the plane-fit to the data
%
% Adapted from detrend_2d.m 
%
